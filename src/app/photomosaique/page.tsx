            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="relative bg-gradient-to-r from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-purple-500/20">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  Collaboratif, Évolutif, <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Spectaculaire !</span>
                </h3>
                <p className="text-xl text-gray-300 mb-8">
                  En temps réel, créez une <span className="text-purple-400 font-bold">œuvre d'art collective</span> qui implique tous vos invités dans une expérience inoubliable.
                </p>
                <Link
                  href="/contact"
